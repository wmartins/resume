...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item
            ...
            \begin{itemize}
                \resitem{Worked as a consultant for one of the biggest Brazilian media companies, developing a standardized React component library that was used mainly on Web and TV platforms}
